        ...
        1: [function (e, t, i) {
            ...
            var a = function () {
                function u(e, t) {
                    ...
                    } else for (var r = 0; r < this.span.length; r++) this.span[r].outerHTML = "";
                ...
                return e = u, i = [{
                    ...
                    key: "getCoefficient", value: function (e) {
                        ...
                        if ("horizontal" === i.dataset.direction) a = ((t ? e.touches[0].clientX : e.clientX) - s.left) / s.width; else if ("vertical" === i.dataset.direction) {
                            var n = s.height;
                    ...
                    key: "pressKb", value: function (e) {
                        ...
                        switch (t.keyCode) {
                            case 13:
                            case 32:
                                if (document.activeElement.parentNode === this.playPauseBtn) this.togglePlay(); else if (document.activeElement.parentNode === this.volumeBtn || document.activeElement === this.sliders[1]) {
